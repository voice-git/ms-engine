...
<a href="#anker1" class="youtube-logo">
    <img class="xpc" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/fixedbtn_tenpo.png" alt="">
    <img class="xsp" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/fixedbtn_tenpo_sp.png" alt="">
</a>
...
-->
        <div class="img">
            <img class="xpc" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/mv.jpg" alt="">
            <img class="xsp" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/mv_sp.jpg" alt="">
        </div>
    </div>

    <div class="point">
        <h1>
            楽天車検の<span class="red">4<span class="min">つ</span></span>の<br class="xsp">ポイント
        </h1>
        <div class="point_sec point1 fadeinElem toUp">
            <div class="img">
                <img class="xpc" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point1.jpg" alt="">
                <img class="xsp" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point1_sp.jpg" alt="">
            </div>
            <div class="text_box">
                <div class="box_inner">
                    ...
                    <p class="text">
                        楽天車検は、インターネットからの<br class="xsp">お申し込み限定で<br class="xpc">割引やポイント還元など<br class="xsp">おトクな<br class="xpc">キャンペーンを実施しています。
                    </p>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point1_ico.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="point_sec point2 fadeinElem toUp">
            <div class="text_box">
                <div class="box_inner">
                    ...
                    <p class="title">高品質な車検サービス</p>
                    <p class="text">
                        指定の整備工場と厳しい基準を<br>
                        クリアした高い技術で、<br>
                        安心して車検を受けることができます。
                    </p>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point2_ico.png" alt="">
                </div>
            </div>
            <div class="img">
                <img class="xpc" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point2.jpg" alt="">
                <img class="xsp" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point2_sp.jpg" alt="">
            </div>
        </div>

        <div class="point_sec point3 fadeinElem toUp">
            <div class="img">
                <img class="xpc" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point3.jpg" alt="">
                <img class="xsp" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point3_sp.jpg" alt="">
            </div>
            <div class="text_box">
                <div class="box_inner">
                    <div class="num">03</div>
                    <p class="title">わかりやすいお見積もり</p>
                    <p class="text">
                        お見積もり時に必要な整備をご説明し、<br>
                        納得のいく価格で車検が<br class="xsp">ご利用できます。
                    </p>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point3_ico.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="point_sec point4 fadeinElem toUp">
            <div class="img">
                <img class="xpc" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point4.jpg" alt="">
                <img class="xsp" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point4_sp.jpg" alt="">
            </div>
            <div class="text_box">
                <div class="box_inner">
                    <div class="num">04</div>
                    <p class="title">24時間お申し込みOK！</p>
                    <p class="text">
                        オンラインで24時間いつでも<br class="xsp">お申し込みが可能！<br>
                        必要な情報を入力するだけで、<br class="xsp">見積もり予約が完了し、<br>
                        スムーズに車検を受けることができます。
                    </p>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/point4_ico.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="map">
        <h2>楽天Car車検加盟店舗一覧<img src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/under.png" alt=""></h2>
        ...
        <div class="gmap">
            <div class="inner" style="padding-bottom:0; height:100%">
                ...
                <script type="text/javascript">
                    ...
                    markers["marker19"] = {
                        lat: 36.539505237246985,
                        lng: 136.57108066681099,
                        title: "アサンテ宮永SS",
                    ...
                    markers["marker20"] = {
                        ...
                        title: "グリーンポート金沢SS",
                        content: "<strong>グリーンポート金沢SS</strong><br />石川金沢市南新保町ト135-1<br />076-237-3131<br /><a href='https://www.ms-engine.co.jp/full/グリーンポート金沢ss'>店舗詳細ページへ</a>",
                        service: ",2,3,4,5,6,7,"
                    }
                    ...
                    markers["marker21"] = {
                        ...
                        lng: 136.6669425,
                        title: "東大通SS",
                        content: "<strong>東大通SS</strong><br />石川県金沢市神宮寺1-15-17<br />076-252-8665<br /><a href='https://www.ms-engine.co.jp/full/東大通SS'>店舗詳細ページへ</a>",
                        service: ",2,3,4,5,6,7,"
                    }
                    ...
                    markers["marker21"] = {
                        ...
                        lng:136.6511663,
                        title: "長町SS",
                        content: "<strong>長町SS</strong><br />石川県金沢市玉川町1-1<br />076-262-1711<br /><a href='https://www.ms-engine.co.jp/full/長町ss/'>店舗詳細ページへ</a>",
                        service: ",1,4,5,6,7,"
                    }
                     markers["marker22"] = { 
                        lat:36.583100261513714,
                        lng:136.66723749683055,
                        title: "東大通SS",
                        content: "<strong>東大通SS</strong><br />石川県金沢市神宮寺1-15-17<br />076-252-8665<br /><a href='https://car.rakuten.co.jp/shaken/shop/3126/'>店舗詳細ページへ</a>",
                        service: ",1,4,5,6,7,"
                    }
                    markers["marker23"] = { 
                        lat:36.58846455818793,
                        lng:136.63383524660483,
                        title: "西大通SS",
                        content: "<strong>西大通SS</strong><br />石川県金沢市西念4-19-38<br />076-265-5880<br /><a href='https://car.rakuten.co.jp/shaken/shop/3190/'>店舗詳細ページへ</a>",
                        service: ",1,4,5,6,7,"
                    }
        ...
        <div class="service-box service-box1">
            <div class="box">
                <div class="item">
                    ...
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/2149/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item">
                    <p class="title">コーディアルののいちSS</p>
                    <p class="address">石川県野々市市三日市3-346</p>
                    <p class="tel">TEL.076-248-2105</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/2893/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item">
                    <p class="title">金沢西インターSS</p>
                    <p class="address">石川県金沢市古府1-161</p>
                    <p class="tel">TEL.076-249-6315</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/2535/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item">
                    <p class="title">セントラル金石SS</p>
                    <p class="address">石川県金沢市寺中町ロ24-1</p>
                    <p class="tel">TEL.076-267-4686</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/2957/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item">
                    <p class="title">マンサーナ押野SS</p>
                    <p class="address">石川県金沢市押野2-570</p>
                    <p class="tel">TEL.076-245-4500</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/1366/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item">
                    <p class="title">ライフステージ泉台SS</p>
                    <p class="address">石川県金沢市泉野出町4-14-1</p>
                    <p class="tel">TEL.076-241-9988</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/3038/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item">
                    <p class="title">ツインウェーブ松任SS</p>
                    <p class="address">石川県白山市松本町880-1</p>
                    <p class="tel">TEL.076-274-3688</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/3017/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item award">
                    <img class="award_ico" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/award.png" alt="">
                    <p class="title">加賀産業道SS</p>
                    <p class="address">石川県野々市市上林5-43</p>
                    <p class="tel">TEL.076-248-0068</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/2796/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item">
                    <p class="title">エコウィング御経塚SS</p>
                    <p class="address">石川県野々市市御経塚3-46</p>
                    <p class="tel">TEL.076-249-5155</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/3016/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item award">
                    <img class="award_ico" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/award.png" alt="">
                    ...
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/1367/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item award">
                    <p class="title">アサンテ宮永SS</p>
                    <p class="address">石川県白山市宮永市町453</p>
                    <p class="tel">TEL.076-275-8588</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/3070/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item award">
                    <p class="title">グリーンポート金沢SS</p>
                    <p class="address">石川県金沢市南新保町ト135-1</p>
                    <p class="tel">TEL.076-237-3131</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/3123/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item award">
                    <p class="title">東大通SS</p>
                    <p class="address">石川県金沢市神宮寺1-15-17</p>
                    <p class="tel">TEL.076-252-8665</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/3126/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item award">
                    <p class="title">長町SS</p>
                    <p class="address">石川県金沢市玉川町1-1</p>
                    <p class="tel">TEL.076-262-1711</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/3159/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
                <div class="item award">
                    <p class="title">西大通SS</p>
                    <p class="address">石川県金沢市西念4-19-38</p>
                    <p class="tel">TEL.076-265-5880</p>
                    <a class="more-btn" href="https://car.rakuten.co.jp/shaken/shop/3190/" target="_blank">MORE<img class="no-hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-angle.png" alt=""><img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/top/btn-hover-angle.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="last">
        <div class="title">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/last_title.png" alt="">
        </div>
        <p class="sub_title">
            楽天車検で<br class="xsp">簡単・安心・おトクな<br class="xsp">車検を受けよう！
        </p>
        <p class="text">
            車検に関する悩みやご質問は、<br class="xsp">各店舗のスタッフにお気軽にご相談下さい。<br>
            （株）三谷サービスエンジンはお客様の<br class="xsp">安全なカーライフをサポートいたします！<br>
            楽天車検では、楽天ポイントが貯まる<br class="xsp">お得なキャンペーンを実施中です！
        </p>
        <div class="under">
            <img class="xpc" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/last_under.png" alt="">
            <img class="xsp" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/last_under_sp.png" alt="">
        </div>
    </div>

    <div class="bnr">
        <a href="<?php echo home_url(); ?>/rakuten-wash/">
            <img class="xpc" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/bnr.jpg" alt="">
            <img class="xsp" src="<?php echo get_template_directory_uri(); ?>/assets/images/rakuten-inspection/bnr_sp.jpg" alt="">
        </a>
    </div>
